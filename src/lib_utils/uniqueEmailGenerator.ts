 ...
 *
 * format: `${word1}${3numbers}@${word2}.${suffix}`
 *
 */
...
function generateEmail(word1: WordList, word2: WordList, suffix: WordList): string {
  const idx1: number = getRandomInt(word1.length),
        ...
        idx3: number = getRandomInt(suffix.length);

  return `${word1[idx1]}${getRandomInt(10)}${getRandomInt(10)}${getRandomInt(10)}@${word2[idx2]}.${suffix[idx3]}`;
}

const SUFFIX: WordList = [
  'com',
  'net',
  'go',
  'gov',
